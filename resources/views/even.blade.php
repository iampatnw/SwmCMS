  ...
  <head>
    ...
    <style>
        body {
            ...
            background-image: url({{ URL::to('/') }}/assets/fontend/img/bg.png);
          ...
          <div class="well">
              <div class="row">
                  ...
                  <ul class="breadcrumb">
                        ...
                        <li><a href="{{ URL::to('/') }}">ปฏิทินกิจกรรม</a></li>
                        <li class="active">รายละเอียดกิจกรรม</li>
                  </ul>
                   <h1> {{ $data->title}} </h1>
                    <?php echo "$data->activities"; ?>

                     <h4 class="text-success">สถานที่ / การเเต่งกาย </h4>
                       <p> {{ $data->location}}</p>
                      <h4 class="text-success">หน่วยงานเจ้าของเรื่อง</h4>
                       <p> {{ $data->eventwho}}</p>
                 </div>
        </div>
        </div>
