          ...
          <div class="well">
              <div class="row">
                  <div class="col-lg-3  ">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <center><img src="{{ URL::to('/') }}/assets/fontend/img/person.png" width="160px" height="200px" class="img-thumbnail"> <br/></center>
                    ...
                    <div class="list-group">
                        ...
                        <a href="http://www.moe.go.th/" target="_blank" ><img src="{{ URL::to('/') }}/assets/fontend/img/04-moe.gif"> </a>
                        <a href="http://www.moe.go.th/" target="_blank" ><img src="{{ URL::to('/') }}/assets/fontend/img/04-moe.gif" > </a>
                        <a href="http://www.moe.go.th/" target="_blank" ><img src="{{ URL::to('/') }}/assets/fontend/img/04-moe.gif" > </a>
                        <a href="http://www.moe.go.th/" target="_blank" ><img src="{{ URL::to('/') }}/assets/fontend/img/04-moe.gif" > </a>
                        <a href="http://www.moe.go.th/" target="_blank" ><img src="{{ URL::to('/') }}/assets/fontend/img/04-moe.gif" > </a>
                  ...
                  <ul class="breadcrumb">
                        ...
                        <li class="active">สมุดเยี่ยม</li>
                  </ul>
                      <div class="panel panel-success">
                        <div class="panel-heading">
                            <center>สมุดเยี่ยมม</center>
                        </div>
                      </div>
                       @foreach  ($data as $dbs )
                      @if ($dbs->status==1)
                   <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title">เยี่ยมชมที่ {{ $dbs->id }}</h3>
                        </div>
                        <div class="panel-body">
                        ...
                        <div class="panel-footer">
                            <i class="fa fa-user" aria-hidden="true"></i> โพสต์โดย {{ $dbs->name }} | <i class="fa fa-globe" aria-hidden="true"></i> ไอพี : {{ $dbs->ipaddress }}
                            <div style="float:right" class="bul_guest03">วันที่ : <span style=" color:#F60">{{ $dbs->date }} | เวลา {{ $dbs->time }}</span></div>
                      ...
                      @endforeach
                        ...
                        <div class="panel panel-danger">
                            <div class="panel-heading">
                                <h3 class="panel-title">กฎกติกาของสมุดเยี่ยมโรงเรียน</h3>
                            </div>
                            <div class="panel-body">
                              <p> 1) ......................................................... </p>
                              <p> 2) ......................................................... </p>
                    ...
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title">คำติชม-เเนะนำ</h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" method="post" action="{{ URL::to('/guestbook') }}">
                              <input type="hidden" name="_token" value="<?php echo csrf_token() ?>">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail" class="col-lg-2 control-label">อีเมลล์</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="inputEmail" placeholder="อีเมลล์">
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label for="inputEmail" class="col-lg-2 control-label">ชื่อ-สกุล</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="inputName" placeholder="ชื่อ-สกุล">
                                    </div>
                                </div>
