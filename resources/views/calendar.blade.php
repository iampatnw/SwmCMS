    ...
    $('#calendar').fullCalendar({
        ...
        events: [
		 @foreach  ($data as $dbs)
            ...
            title :'{{ $dbs->title }}',
            start :'{{ $dbs->start }}T{{ $dbs->time_start }}',
            end :'{{ $dbs->end }}T{{ $dbs->time_end }}',
            url: '{{ URL::to('/even-view') }}/{{ $dbs->id }}'
  ...
  <body>
      <div class="container">
        ...
        <nav class="navbar navbar-default">
            ...
            <div class="navbar-header">
                <a class="navbar-brand">{{ $info->school_th }}</a>
            </div>
            <ul class="nav navbar-nav navbar-right">
                <a class="navbar-brand">โทร: {{ $info->phone }}</a>
            </ul>
            </div>
        </nav>
      <!-- Slide photo  -->
      <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img src="{{ URL::to('/') }}/assets/img/12.png" alt="First slide" width="1170px">
          </div>
          <div class="item">
            <img src="{{ URL::to('/') }}/assets/img/12.png" alt="First slide" width="1170px" >
          </div>
      ...
      <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#"><i class="fa fa-lock" aria-hidden="true"></i> เข้าระบบAdmin</a></li>
            </ul>
            </div>
        </div>
    </nav>
              ...
              <div class="row">
                  <div class="col-lg-3  ">
                    ...
                    <div class="list-group">
                        ...
                        <a href="http://www.moe.go.th/" target="_blank" ><img src="/assets/img/04-moe.gif"> </a>
                        <a href="http://www.moe.go.th/" target="_blank" ><img src="/assets/img/04-moe.gif" > </a>
                        <a href="http://www.moe.go.th/" target="_blank" ><img src="/assets/img/04-moe.gif" > </a>
                        <a href="http://www.moe.go.th/" target="_blank" ><img src="/assets/img/04-moe.gif" > </a>
                        <a href="http://www.moe.go.th/" target="_blank" ><img src="/assets/img/04-moe.gif" > </a>
