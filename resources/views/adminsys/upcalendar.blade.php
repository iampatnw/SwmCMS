				...
				<div class="row">
                    ...
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="post" action="{{ URL::to('/adminsys/update_calendar') }}">
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="inputtitle"  value="{{ $data->title}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="textArea" class="col-lg-2 control-label">กิจกรรม</label>
                                    <div class="col-lg-10">
                                        <textarea class="ckeditor" rows="3" name="message" id="textArea">{{ $data->activities }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail" class="col-lg-2 control-label">เริ่มวันที่</label>
                                    <div class="col-lg-10">
                                        <input type="date" class="form-control" name="startdate" value="{{ $data->start}}">
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label for="inputEmail" class="col-lg-2 control-label">เริ่มเวลา</label>
                                    <div class="col-lg-10">
                                        <input type="time" class="form-control" name="starttime"value="{{ $data->time_start}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail" class="col-lg-2 control-label">สิ้นสุดวันที่</label>
                                    <div class="col-lg-10">
                                        <input type="date" class="form-control" name="enddate" value="{{ $data->end}}">
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label for="inputEmail" class="col-lg-2 control-label">สิ้นสุดเวลา</label>
                                    <div class="col-lg-10">
                                        <input type="time" class="form-control" name="enstime" value="{{ $data->time_end}}">
                                    </div>
                                 </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="eventwho" value="{{ $data->eventwho}}">
                                    </div>
                                 </div>
                                <div class="form-group">
								    <label class="col-sm-2 control-label">สีพื้นหลัง</label>
								    <div class="col-sm-10">
								        <input class="jscolor" name="bgcolor" value="{{ $data->color}}">
								    </div>
								</div>
                                <div class="form-group">
