									...
									<tbody>
                                       @foreach  ($data as $dbs)
										<tr>
                                            ...
                                            <td>{{ $dbs->ipaddress }}</td>
                                            @if ($dbs->status==0)
                                            <td><span class="label label-danger">รอการอยุมัติ </span></td>
                                            @else
                                            <td><span class="label label-success">อนุมัติเรียบร้อย </span></td>
                                            @endif
                                            <td><a href="{{ URL::to('/adminsys/book') }}/{{ $dbs->id }}" class="btn btn-info">อนุมัติ</a></td>
                                            <td><a href="{{ URL::to('/adminsys/del') }}/{{ $dbs->id }}" class="btn btn-info">ลบ</a></td>
										</tr>
