	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">ประวัติโรงเรียน</h2>

			             <div class="panel panel-default">
									<div class="panel-heading">ประวัติโรงเรียน</div>
									<div class="panel-body">
										<form method="post" class="form-horizontal" action="{{ URL::to('/adminsys/history') }}">
											<div class="form-group">
												<label class="col-sm-2 control-label">หัวข้อข่าว</label>
												<div class="col-sm-10">
													<input type="text" name="toppic" class="form-control" value="{{ $data->toppic }}">
												</div>
											</div>
                                            <div class="form-group">
												<label class="col-sm-2 control-label">เนื้อหา</label>
												<div class="col-sm-10">
													<textarea class="ckeditor" name="history">{{ $data->history }} </textarea>
												</div>
											</div>
                                           	<div class="form-group">
