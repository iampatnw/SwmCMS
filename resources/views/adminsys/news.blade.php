			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
                        ...
                        <a href="{{ URL::to('/adminsys/addnews') }}" class="btn btn-info">เพิ่มข่าวประชาสัมพันธ์</a>
                        <p>
							...
							<div class="panel-body">
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<tr>
											<td>{{ $dbs->toppic }}</td>
											<td><a href="{{ URL::to('/') }}/assets/custom/img/logo.jpg"   target="popup"   onclick="window.open('{{ URL::to('/') }}/assets/custom/img/logo.jpg','popup','width=600,height=600'); return false;">ดูรูป</a></td>
                                            <td><a href="{{ URL::to('/') }}/assets/custom/img/logo.jpg"   target="popup"   onclick="window.open('{{ URL::to('/') }}/assets/custom/img/logo.jpg','popup','width=600,height=600'); return false;">ดูไฟล์</a></td>
											<td>{{ $dbs->date }}</td>
                                            <td><a href="#" class="btn btn-info">แก้ไข</a></td>
