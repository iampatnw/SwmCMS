              ...
              <div class="row">
                  ...
                  <ul class="breadcrumb">
                      ...
                      <div class="panel panel-success">
                        <div class="panel-heading">
                            <center>เรื่องร้องเรียน</center>
                        </div>
                      </div>
                       <!-- เพิ่ม การเยี่ยมชม -->
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title">เรื่องร้องเรียน</h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" method="post" action="{{ URL::to('/complain') }}">
                              <input type="hidden" name="_token" value="<?php echo csrf_token() ?>">
                              <div class="form-group">
                                  <label for="inputEmail" class="col-lg-2 control-label">เรื่องร้องเรียน</label>
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" name="inputtitle" placeholder="เรื่องร้องเรียน">
                                  </div>
                              </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="col-lg-10">
                                       <input type="text" class="form-control" name="inputphone" placeholder="เบอร์โทร">
                                   </div>
                                </div>
                                <div class="form-group">
